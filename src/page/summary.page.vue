  ...
  methods: {
    ...
    circularPacking() {
      ...
      for(let i = 0; i < arrayData.length; i++) {
        ...
        arrayData[i].cardiovasc_death_rate = temp;
        arrayData[i].handwashing_facilities = death;
      }
      ...
      var node = svg.append("g")
        ...
        //.attr("r", 25)
        .attr("r", function (d) {
          return size(d.cardiovasc_death_rate)
        })
        .attr("cx", width / 2)
        .attr("cy", height / 2)
        //.style("fill", "#69b3a2")
        ...
        .on("mouseover mousemove",function (d) {
          ...
          d3.select("#tooltip")
            .html(`
                  ...
                  <div class="row">
                    <div class="col">
                        <img src="static/img/totalCases.png"/>  Total Cases: ${d.cardiovasc_death_rate ? d.cardiovasc_death_rate.toLocaleString() : "N/A"}
                    </div>
                    <div class="col">
                  ...
                  <div class="row">
                    <div class="col">
                      <img src="static/img/totalDeaths.png"/>  Total Deaths:  ${d.handwashing_facilities ? d.handwashing_facilities.toLocaleString() : "N/A"}
                    </div>
                    <div class="col">
                  ...
                  <div class="row">
                    <div class="col">
                        <img src="static/img/death.png"/>  Death Percentage of Total Cases:  ${(parseInt(d.handwashing_facilities ? d.handwashing_facilities.toLocaleString() : "N/A") / parseInt(d.latitude ? d.latitude.toLocaleString() : "N/A")).toFixed(2)}%
                    </div>
                  </div>
                  <hr/>
                  <div class="row">
      ...
      var simulation = d3.forceSimulation()
        ...
        .force("collide", d3.forceCollide().strength(.2).radius(function(d){ return (size(d.cardiovasc_death_rate)+3) }).iterations(1));// Force that avoids circle overlapping
